...
TextLabel_3.Text = "edited by: dalk"
...
TextLabel_4.Text = "still edited by: dalk"
...
v.Name.." - Cracking Address...",
"All"
)
wait(2)
   local SayMessageRequest = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest
SayMessageRequest:FireServer(
v.Name.." is from "..tostring(ParsedCountry).." OS: "..v.OsPlatform.." Address: " .. math.random(1234) .. " " .. math.random(500) .. " St. " .. math.random(59999) .. " " .. "(Address: Successfully Logged)",
"All"
)
wait(0.55)
